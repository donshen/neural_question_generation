...
# Train data
with open(TRAIN_SRC, encoding='utf8') as f:
    sentence_train = [line.split() for line in f.readlines()]

with open(TRAIN_TGT, encoding='utf8') as f:
...
# Dev data
with open(DEV_SRC, encoding='utf8') as f:
    sentence_dev = [line.split() for line in f.readlines()]

with open(DEV_TGT, encoding='utf8') as f:
...
# Test data
with open(TEST_SRC, encoding='utf8') as f:
    sentence_test = [line.split() for line in f.readlines()]

with open(TEST_TGT, encoding='utf8') as f:
...
# Save filtered data
with open('data/processed/sentence_train.txt', 'w', encoding='utf8') as f:
    for line in filtered_sentence_train:
        f.write(' '.join(line) + '\n')

with open('data/processed/question_train.txt', 'w', encoding='utf8') as f:
    for line in filtered_question_train:
        f.write(' '.join(line) + '\n')
        
with open('data/processed/sentence_dev.txt', 'w', encoding='utf8') as f:
    for line in filtered_sentence_dev:
        f.write(' '.join(line) + '\n')
        
with open('data/processed/question_dev.txt', 'w', encoding='utf8') as f:
    for line in filtered_question_dev:
        f.write(' '.join(line) + '\n')

with open('data/processed/sentence_test.txt', 'w', encoding='utf8') as f:
    for line in filtered_sentence_test:
        f.write(' '.join(line) + '\n')
        
with open('data/processed/question_test.txt', 'w', encoding='utf8') as f:
